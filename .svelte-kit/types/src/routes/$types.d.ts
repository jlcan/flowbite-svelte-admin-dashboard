...
type LayoutRouteId = RouteId | "/(no-layout)/pages/pricing" | "/(no-sidebar)/layouts/stacked" | "/(no-sidebar)/pages/[slug]" | "/(no-sidebar)/playground/stacked" | "/(sidebar)" | "/(sidebar)/crud/products" | "/(sidebar)/crud/users" | "/(sidebar)/dashboard" | "/(sidebar)/layouts/sidebar" | "/(sidebar)/playground/sidebar" | "/(sidebar)/settings" | "/(sidebar)/[slug]" | "/authentication/[slug]" | "/errors/[code]" | null
