...
type LayoutRouteId = RouteId | "/(sidebar)" | "/(sidebar)/crud/products" | "/(sidebar)/crud/users" | "/(sidebar)/dashboard" | "/(sidebar)/layouts/sidebar" | "/(sidebar)/playground/sidebar" | "/(sidebar)/settings" | "/(sidebar)/[slug]"
